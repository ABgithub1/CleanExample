...
import com.example.githubclient.presentation.extension.addPaginationScrollListener
import com.example.githubclient.presentation.extension.addVerticalSpaceDecoration
import com.example.githubclient.presentation.extension.applyHorizontalWindowInsets
import com.example.githubclient.presentation.extension.applyWindowInsets
import com.example.githubclient.presentation.model.PagingDisplayItem
import com.example.githubclient.presentation.paging.PagingLceState
import com.example.githubclient.presentation.ui.users.adapter.UserAdapter
                ...
                .onEach { state ->
                    ...
                    when (state) {
                        is PagingLceState.FirstLoadingError -> {
                            Snackbar.make(
                                view,
                                state.throwable.localizedMessage ?: getString(R.string.general_error),
